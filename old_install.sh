...
rm /home/$user/hypr/hyprpaper.conf
...
cp $current_path/wallpapers/1.jpg /home/$user/.config/hypr/wallpaper
#ln -s $current_path/scripts/wallpaper.sh /home/$user/.config/hypr/scripts/wallpaper.sh
cp $current_path/hypr/hyprpaper.conf /home/$user/.config/hypr
