...
then
	pkgs=(hyprland polkit nano kitty rofi thunar brightnessctl pavucontrol playerctl ly rsync waybar wlogout otf-font-awesome jsoncpp-doc hyprpaper xdg-desktop-portal xdg-desktop-portal-hyprland pipewire wireplumber xwaylandvideobridge-bin)
else
    pkgs=(rsync waybar wlogout nano kitty rofi thunar otf-font-awesome jsoncpp-doc hyprpaper xdg-desktop-portal xdg-desktop-portal-hyprland pipewire wireplumber xwaylandvideobridge-bin brightnessctl pavucontrol playerctl)
fi
